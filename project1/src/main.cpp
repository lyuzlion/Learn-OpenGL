...
glm::vec3 model_pos = glm::vec3(0.0f, -1.0f, 0.0f);
glm::vec3 model_scale = glm::vec3(1.5f, 1.5f, 1.5f);
float model_angle = 0;
...
int main(int argc, char *argv[])
{
    ...
    Shader ourShader("E:/SDU/ComputerGraphics/WorkSpace/project1/src/shader/vertex.glsl", "E:/SDU/ComputerGraphics/WorkSpace/project1/src/shader/fragment.glsl");
    Shader lightObjectShader("E:\\SDU\\ComputerGraphics\\WorkSpace\\project1\\src\\shader\\light_object_vert.glsl", "E:\\SDU\\ComputerGraphics\\WorkSpace\\project1\\src\\shader\\light_object_frag.glsl");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        std::string newTitle = "Project 1 - " + ms + " ms/frame " + FPS;
        ...
        model = glm::rotate(model, glm::radians(15.0f * model_angle), glm::vec3(0.0f, 1.0f, 0.0f)); // 绕y轴旋转
