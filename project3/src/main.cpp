...
int main()
{
	...
	// lights
	scene.lights_point.push_back(SceneManager::create_light_point({ 0, 2, 4, 0.5 }, { 1, 1, 1 }, 25.5));
	// scene.lights_point.push_back(SceneManager::create_light_point({ 0, 2, 0, 0.1 }, { 1, 1, 1 }, 25.5));
	scene.lights_direct.push_back(SceneManager::create_light_direct({ -3, -1, 2 }, { 1, 1, 1 }, 1.5));

	// blue sphere
	scene.spheres.push_back(SceneManager::create_sphere({ -8, 0, 10 }, 1,
		SceneManager::create_material({ 0, 0, 1 }, 50, 0.1), true));
	// red sphere
	scene.spheres.push_back(SceneManager::create_sphere({ -6, 0, 10 }, 1,
	...
	// Ceiling
	scene.boxes.push_back(SceneManager::create_box({ 0, 10, 6 }, { 10, 0.2, 5 },
    	SceneManager::create_material({ 0.8, 0.8, 0.8 }, 100, 0.05)));

	// Left Wall
	scene.boxes.push_back(SceneManager::create_box({ -10, 4, 6 }, { 0.2, 7, 5 },
    	SceneManager::create_material({ 0.8, 0.8, 0.8 }, 100, 0.05)));

	scene.boxes.push_back(SceneManager::create_box({ 10, 4, 6 }, { 0.2, 7, 5 },
    	SceneManager::create_material({ 0.8, 0.8, 0.8 }, 100, 0.05)));
	
	scene.boxes.push_back(SceneManager::create_box({ 0, 5, 11 }, { 10, 7, 0.2 },
    	SceneManager::create_material({ 0.8, 0.8, 0.8 }, 100, 0.05)));
	// scene.boxes.push_back(SceneManager::create_box({ 0, -1.2, 6 }, { 10, 0.2, 5 },
	// 	SceneManager::create_material({ 1, 0.6, 0 }, 100, 0.05)));
	// box
